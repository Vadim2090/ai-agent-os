...
- Career, positioning and track record live in `profile.md`. Read it only when the task is about me: a CV,
  a profile, an application, a bio. It is not loaded every session.
