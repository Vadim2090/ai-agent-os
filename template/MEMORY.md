...
> `- [Title]({{topic-file}}.md) — hook`. Detail goes in the topic file next to this one. Lines past ~200 are
...
- [Example: how I like numbers reported]({{numbers-with-denominators}}.md) — every rate carries its base.
